...
var numsub = document.getElementById('-');
var numadd = document.getElementById('+');
var nummul = document.getElementById('*');
var numdiv = document.getElementById('/');
var num00 = document.getElementById('00');
var numdper = document.getElementById('%');
var out = document.getElementById('output');
num0 == onclick == console.log(num0);